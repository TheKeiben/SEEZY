...
!\[ROS 2 Jazzy](https://img.shields.io/badge/ROS\_2-Jazzy-22314E?style=for-the-badge\&logo=ros\&logoColor=white)

!\[JetPack 7.2](https://img.shields.io/badge/NVIDIA-JetPack\_7.2-76B900?style=for-the-badge\&logo=nvidia\&logoColor=white)

!\[PyQt6](https://img.shields.io/badge/PyQt6-UI\_Dashboard-41CD52?style=for-the-badge\&logo=python\&logoColor=white)



!\[SEEZY Robot Hero Shot](docs/images/hero\_shot.png)

!\[SEEZY Robot Internal Shot 1](docs/images/internal\_shot1.png)

!\[SEEZY Robot Internal Shot 2](docs/images/internal\_shot2.png)
...
!\[System Architecture](docs/images/architecture\_diagram.png)
...
\### 2. `ros2\_workspace/` (Robot Navigation \& Bringup)
...
\### 3. `image\_processing/` (Vision Pipeline Development)

The computer vision sandbox. While production inference runs via the `perception/vision\_node.py` subprocess\[cite: 21], this folder contains the development pipelines: Google Colab YOLOv8 training notebooks, local Windows testing scripts, and TensorRT (`.engine`) conversion tools\[cite: 17, 24].
...
\*   ESP32 maps to: `/dev/seezy\_esp`\[cite: 23]

\*   LiDAR maps to: `/dev/seezy\_lidar`\[cite: 23]
...
!\[SEEZY Dashboard](docs/images/dashboard\_ui.png)
...
2\. Launch the UI using your bash script (e.g., `./start\_ui.sh` or `python3 main.py`).
